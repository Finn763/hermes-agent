...
export const ru = defineLocale({
  ...
  messaging: {
    ...
    unknown: 'Неизвестно',
    hintPendingRestart: 'Перезапустите шлюз сообщений, чтобы применить это изменение.',
    sharedListenerUrl: 'Обслуживается общим слушателем шлюза по адресу',
    hintGatewayStopped: 'Шлюз сообщений остановлен. Запустите его здесь, чтобы подключиться.',

...
export const ru = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      turnAnchorTitle: 'Позиция после хода',
      turnAnchorDesc:
        'Куда переходит вид, когда ход завершён. «Начало моего запроса» останавливается на начале последнего сообщения, чтобы читать обмен сверху вниз; если вы прокрутили вверх во время хода, позиция чтения сохраняется.',
      turnAnchorBottom: 'Конец ответа',
      turnAnchorPrompt: 'Начало моего запроса',

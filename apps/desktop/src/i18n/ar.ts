...
export const ar = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      turnAnchorTitle: 'موضع العرض عند انتهاء الدور',
      turnAnchorDesc:
        'أين يتوقف العرض عند انتهاء الدور. «بداية رسالتي» يثبّت العرض عند بداية رسالتك الأخيرة لتقرأ المحادثة من الأعلى إلى الأسفل؛ وإذا مرّرت لأعلى أثناء الدور، يبقى العرض في موضعك.',
      turnAnchorBottom: 'نهاية الرد',
      turnAnchorPrompt: 'بداية رسالتي',

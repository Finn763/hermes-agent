...
def _create_with_progress_once(
    ...
    # #114938: dispatch is telemetry, never summary progress — ticking the progress hook here
    # re-armed the compression fence's inactivity budget for auth refreshes/retries/fallbacks
    # that produced no payload at all, letting a zero-output attempt run to the total ceiling.

...
Write only the summary body. Do not include any preamble or prefix."""
    ...
    def compress(
        ...
        _can_dedup = (
            ...
            and not self._last_summary_empty_content_failure
            and not self._last_summary_network_failure
            and not self._last_summary_auth_failure
            and not self._last_summary_truncated_failure
            and self._ineffective_compression_count == 0
        )
        if not force and _fp is not None and _fp == self._last_compress_fingerprint and _can_dedup:
